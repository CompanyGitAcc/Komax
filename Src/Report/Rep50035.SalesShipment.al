report 50035 "Sales Shipment"
{
    WordLayout = './Layout/SalesShipment.docx';
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            column(SalesPurchPerson; SalesPurchPerson."Name 2")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocDate_SalesShptHeader; Format("Sales Shipment Header"."Document Date", 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(ShptDate_SalesShptHeader; Format("Sales Shipment Header"."Shipment Date", 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(Qty_SalesShptLine; Format(QtySalesShptLine))
                        {
                        }
                        ...
                        column(QtySalesLine; QtySalesLine)
                        {
                        }
                        ...
                        begin
                            ...
                            if SalesLine.get(SalesLine."Document Type"::Order, "Order No.", "Order Line No.") then begin
                                if SalesLine.Quantity = 0 then
                                    ...
                                    QtySalesLine := format(SalesLine.Quantity);
                            end;

                            if Quantity = 0 then
                                QtySalesShptLine := ''
                            else
                                QtySalesShptLine := format(Quantity);
                        end;
    ...
    var
        ...
        QtySalesLine: Text[20];
        QtySalesShptLine: Text[20];
