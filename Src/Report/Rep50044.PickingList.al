report 50044 "Picking List 2"
{
    WordLayout = './Layout/PickingList.docx';
        ...
        dataitem("Warehouse Activity Header"; "Warehouse Activity Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Warehouse Activity Line"; "Warehouse Activity Line")
                {
                    ...
                    DataItemTableView = SORTING("Trolley No.", "Bin Code") WHERE("Action Type" = filter("Take" | " "));
                ...
                dataitem(WhseActLine; "Warehouse Activity Line")
                {
                    ...
                    column(Trolley_No_; "Trolley No.")
                    {
                    }
                    column(SODescription; SODescription)
                    {
                    }
                    column(SONo; SONo)
                    {
                    ...
                    begin
                        ...
                        if "Source Document" = "Source Document"::"Sales Order" then begin
                            ...
                            if SalesHeader.get(SalesHeader."Document Type"::Order, "Source No.") then begin
                                ...
                                CustomerName := SalesHeader."Sell-to Customer Name 2";
                            end;
                        end;
                    end;
