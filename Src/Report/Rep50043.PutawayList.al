report 50043 "Put Away List"
{
    WordLayout = './Layout/PutAwayList.docx';
        ...
        dataitem("Warehouse Activity Header"; "Warehouse Activity Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Warehouse Activity Line"; "Warehouse Activity Line")
                {
                    ...
                    DataItemTableView = SORTING("No.", "Trolley No.", "Activity Type", "Sorting Sequence No.") WHERE("Action Type" = filter("Take" | " "));
