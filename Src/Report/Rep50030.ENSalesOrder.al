report 50030 "EN Sales Order"
{
    WordLayout = './Layout/ENSalesOrder.docx';
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    if Header."Prices Including VAT" = true then begin
                        UnitPriceLbl := 'Unit Price Incl. VAT';
                        AmountCNYInclVAT := 'Amount / ' + CurrencyCode + ' Incl.VAT';
                    end else begin
                        UnitPriceLbl := 'Unit Price Excl. VAT';
                        AmountCNYInclVAT := 'Amount / ' + CurrencyCode + ' Excl.VAT';
                    end;
