report 50036 "EN Purchase Order"
{
    WordLayout = './Layout/ENPurchaseOrder.docx';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        begin
                            ...
                            TotalVATAmount2 := TempVATAmountLine.GetTotalVATAmount;
                        end;
            ...
            begin
                ...
                if "Prices Including VAT" = true then begin
                    UnitPriceLbl := 'Direct Unit Cost Incl. VAT';
                    LineAmountLbl := 'Line Amount Incl. VAT (' + CurrencyCode + ')';
                end else begin
                    UnitPriceLbl := 'Direct Unit Cost Excl. VAT';
                    LineAmountLbl := 'Line Amount Excl. VAT (' + CurrencyCode + ')';
                end;
