report 50033 "CN Sales Order"
{
    WordLayout = './Layout/CNSalesOrder.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(YourReference; "Sell-to Contact")
            {
            }
            ...
            column(DocumentDate; FORMAT("Document Date", 0, '<Year4>-<Month,2>-<Day,2>'))
            {
            }
            ...
            //++YK999-HH220524
            column(LegalRepresentativeOfCompany; CompanyInfo."Legal Representative")
            {
            }
            column(Contact_Company; CompanyInfo."Contact Person")
            {
            }
            column(Fax_No_Company; CompanyInfo."Fax No.")
            {
            }
            ...
            column(Phone_No_Customer; Customer."Phone No.")
            {
            }
            column(Fax_No_Customer; Customer."Fax No.")
            {
            }
            column(Post_Code_Customer; Customer."Post Code")
            {
            }
            column(Address_Customer; Customer.Address)
            {
            }
            column(CustomerBankAccountNo; CustomerBankAccountNo)
            {
            }
            column(CustomerBankName; CustomerBankName)
            {
            }
            column("VAT_Registration_No_Customer"; Customer."VAT Registration No.")
            {
            ...
            column(Sell_to_Address; "Sell-to Address 2")
            {
            }
            column(Bill_to_Address; "Bill-to Address 2")
            {
            }
            ...
            column(Sell_to_Customer_Name; "Sell-to Customer Name 2")
            {
            }
            ...
            column(Bill_to_Name; "Bill-to Name 2")
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                //++Harvey
                column(Requested_Delivery_Date; FORMAT("Requested Delivery Date", 0, '<Year4>-<Month,2>-<Day,2>'))
                {
                }
                column(VAT__; VAT2)
                {
                ...
                column(AmountCNYInclVAT; AmountCNYInclVAT)
                {
                }
                //--YK999
                ...
                begin
                    ...
                    if Header."Prices Including VAT" = true then begin
                        UnitPriceLbl := '含税单价';
                        AmountCNYInclVAT := '含税行金额 (' + CurrencyCode + ')';
                    end else begin
                        UnitPriceLbl := '未税单价';
                        AmountCNYInclVAT := '未税行金额 (' + CurrencyCode + ')';
                    end;
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(CapitalAmount; CapitalAmount)
                {
                }
                //--YK999
                trigger OnAfterGetRecord()
                begin
                    CapitalAmount := CNUtilities.AmountInCapital(TotalAmountInclVAT);
                end;
            }
            ...
            begin
                ...
                if Customer.get("Header"."Sell-to Customer No.") then begin
                    if CustomerBankAccount.get(Customer."No.", Customer."Preferred Bank Account Code") then begin
                        CustomerBankAccountNo := CustomerBankAccount."Bank Account No.";
